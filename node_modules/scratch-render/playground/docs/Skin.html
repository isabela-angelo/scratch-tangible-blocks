...
<article>
    ...
    <h4 class="name" id="Skin"><span class="type-signature"></span>new Skin<span class="signature">(id)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Create a Skin, which stores and/or generates textures for use in rendering.</p>
</div>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>WasAltered</code></td>
...
<div class="description">
    <p>These are the events which can be emitted by instances of this class.</p>
</div>
...
<h4 class="name" id="size"><span class="type-signature">(abstract) </span>size<span class="type-signature"></span></h4>
...
<div class="description">
    ...
    <h4 class="name" id="getTexture"><span class="type-signature">(abstract) </span>getTexture<span class="signature">(scale)</span><span class="type-signature"> &rarr; {WebGLTexture}</span></h4>
...
<ul>
    ...
    <h4 class="name" id=".event:event:WasAltered">event:WasAltered</h4>
...
<div class="description">
    <p>Emitted when anything about the Skin has been altered, such as the appearance or rotation center.</p>
</div>
