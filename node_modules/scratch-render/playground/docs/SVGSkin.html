...
<head>
    <meta charset="utf-8">
    <title>SVGSkin - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">SVGSkin</h1>
...
<article>
    ...
    <h4 class="name" id="SVGSkin"><span class="type-signature"></span>new SVGSkin<span class="signature">(id<span class="signature-attributes">non-null</span>, renderer<span class="signature-attributes">non-null</span>)</span><span class="type-signature"></span></h4>
...
<h4 class="name" id="_renderer"><span class="type-signature"></span>_renderer<span class="type-signature"> :<a href="RenderWebGL.html">RenderWebGL</a></span></h4>
...
<h4 class="name" id="_svgRenderer"><span class="type-signature"></span>_svgRenderer<span class="type-signature"> :<a href="SvgRenderer.html">SvgRenderer</a></span></h4>
...
<span class="param-type"><a href="SvgRenderer.html">SvgRenderer</a></span>
...
<div class="description">
    ...
    <h4 class="name" id="getTexture"><span class="type-signature"></span>getTexture<span class="signature">(scale)</span><span class="type-signature"> &rarr; {WebGLTexture}</span></h4>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="setSVG"><span class="type-signature"></span>setSVG<span class="signature">(svgData, rotationCenter<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set the contents of this skin to a snapshot of the provided SVG data.</p>
</div>
...
<span class="param-type">Array.&lt;number></span>
            ...
            <td class="description last"><p>Optional rotation center for the SVG. If not supplied, it will be
