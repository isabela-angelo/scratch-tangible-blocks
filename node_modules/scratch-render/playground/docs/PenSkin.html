...
<head>
    <meta charset="utf-8">
    <title>PenSkin - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">PenSkin</h1>
...
<article>
    ...
    <h4 class="name" id="PenSkin"><span class="type-signature"></span>new PenSkin<span class="signature">(id, renderer)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Create a Skin which implements a Scratch pen layer.</p>
</div>
...
<span class="param-type">int</span>
            ...
            <td class="description last"><p>The unique ID for this Skin.</p></td>
        </tr>
...
<h4 class="name" id=".DefaultPenAttributes"><span class="type-signature">(private, static, constant) </span>DefaultPenAttributes<span class="type-signature"> :<a href="PenSkin.html#PenAttributes">PenSkin#PenAttributes</a></span></h4>
...
<div class="description">
    <p>The pen attributes to use when unspecified.</p>
</div>
...
<span class="param-type"><a href="PenSkin.html#PenAttributes">PenSkin#PenAttributes</a></span>
...
<h4 class="name" id="_canvas"><span class="type-signature"></span>_canvas<span class="type-signature"> :HTMLCanvasElement</span></h4>
...
<h4 class="name" id="_canvasDirty"><span class="type-signature"></span>_canvasDirty<span class="type-signature"> :boolean</span></h4>
...
<h4 class="name" id="_renderer"><span class="type-signature">(private) </span>_renderer<span class="type-signature"> :<a href="RenderWebGL.html">RenderWebGL</a></span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="_setAttributes"><span class="type-signature">(private) </span>_setAttributes<span class="signature">(context, penAttributes)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set context state to match provided pen attributes.</p>
</div>
...
<span class="param-type">CanvasRenderingContext2D</span>
            ...
            <td class="description last"><p>the canvas rendering context to be modified.</p></td>
        </tr>
...
<span class="param-type">PenAttributes</span>
            ...
            <td class="description last"><p>the pen attributes to be used.</p></td>
        </tr>
    ...
    <h4 class="name" id="_setCanvasSize"><span class="type-signature">(private) </span>_setCanvasSize<span class="signature">(canvasSize)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set the size of the pen canvas.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>canvasSize</code></td>
...
<span class="param-type">Array.&lt;int></span>
            ...
            <td class="description last"><p>the new width and height for the canvas.</p></td>
        </tr>
    ...
    <h4 class="name" id="calculateRotationCenter"><span class="type-signature"></span>calculateRotationCenter<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;number>}</span></h4>
...
<div class="description">
    ...
    <h4 class="name" id="drawLine"><span class="type-signature"></span>drawLine<span class="signature">(penAttributes, x0, y0, x1, y1)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Draw a line on the pen layer.</p>
</div>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="drawPoint"><span class="type-signature"></span>drawPoint<span class="signature">(penAttributes, x, y)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Draw a point on the pen layer.</p>
</div>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="drawStamp"><span class="type-signature"></span>drawStamp<span class="signature">(stampElement, x, y)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Stamp an image onto the pen layer.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>stampElement</code></td>
...
<span class="param-type">HTMLVideoElement</span>
            ...
            <td class="description last"><p>the element to use as the stamp.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the X coordinate of the stamp to draw.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the Y coordinate of the stamp to draw.</p></td>
        </tr>
    ...
    <h4 class="name" id="getTexture"><span class="type-signature"></span>getTexture<span class="signature">(pixelsWide, pixelsTall)</span><span class="type-signature"> &rarr; {WebGLTexture}</span></h4>
...
<span class="param-type">int</span>
            ...
            <td class="description last"><p>The width that the skin will be rendered at, in GPU pixels.</p></td>
        </tr>
...
<span class="param-type">int</span>
            ...
            <td class="description last"><p>The height that the skin will be rendered at, in GPU pixels.</p></td>
        </tr>
...
<div class="param-desc">
    <p>The GL texture representation of this skin when drawing at the given size.</p>
</div>
...
<span class="param-type">WebGLTexture</span>
    ...
    <h4 class="name" id="getUniforms"><span class="type-signature"></span>getUniforms<span class="signature">(scale)</span><span class="type-signature"> &rarr; {object.&lt;string, *>}</span></h4>
...
<span class="param-type">object.&lt;string, *></span>
    ...
    <h4 class="name" id="onNativeSizeChanged"><span class="type-signature"></span>onNativeSizeChanged<span class="signature">(event)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>React to a change in the renderer's native size.</p>
</div>
...
<h4 class="name" id="PenAttributes">PenAttributes</h4>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The size (diameter) of the pen.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>color4f</code></td>
...
<span class="param-type">Array.&lt;number></span>
            ...
            <td class="description last"><p>The pen color as an array of [r,g,b,a], each component in the range [0,1].</p></td>
        </tr>
...
<div class="description">
    <p>Attributes to use when drawing with the pen</p>
</div>
