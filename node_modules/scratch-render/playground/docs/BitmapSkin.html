...
<dl class="details">
    ...
    <h4 class="name" id="._getBitmapSize"><span class="type-signature">(private, static) </span>_getBitmapSize<span class="signature">(bitmapData)</span><span class="type-signature"> &rarr; {Array.&lt;int>}</span></h4>
