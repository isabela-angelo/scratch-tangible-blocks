...
<dl class="details">
    ...
    <h4 class="name" id="_createSVGElement"><span class="type-signature"></span>_createSVGElement<span class="signature">(tagName)</span><span class="type-signature"> &rarr; (non-null) {DOMElement}</span></h4>
...
<div class="description">
    ...
    <h4 class="name" id="_findLargestStrokeWidth"><span class="type-signature"></span>_findLargestStrokeWidth<span class="signature">(rootNode)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<div class="description">
    <p>Find the largest stroke width in the svg. If a shape has no
<code>stroke</code> property, it has a stroke-width of 0. If it has a <code>stroke</code>,
it is by default a stroke-width of 1.
This is used to enlarge the computed bounding box, which doesn't take
stroke width into account.</p>
</div>
...
<span class="param-type">SVGSVGElement</span>
            ...
            <td class="description last"><p>The root SVG node to traverse.</p></td>
        </tr>
...
<div class="param-desc">
    <p>The largest stroke width in the SVG.</p>
</div>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="_loadString"><span class="type-signature"></span>_loadString<span class="signature">(svgString)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Load an SVG string and normalize it. All the steps before drawing/measuring.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="_toString"><span class="type-signature"></span>_toString<span class="signature">()</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id="getDrawRatio"><span class="type-signature"></span>getDrawRatio<span class="signature">()</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="measure"><span class="type-signature"></span>measure<span class="signature">(svgString)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<div class="description">
    <p>Load an SVG from a string and measure it.</p>
</div>
...
<div class="param-desc">
    <p>the natural size, in Scratch units, of this SVG.</p>
</div>
